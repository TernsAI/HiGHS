...
RUN wget https://github.com/Kitware/CMake/releases/download/v3.25.0-rc2/cmake-3.25.0-rc2.tar.gz
RUN tar -zxvf cmake-3.25.0-rc2.tar.gz
RUN cmake-3.25.0-rc2/bootstrap
RUN make
RUN make install
